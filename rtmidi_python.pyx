...
cdef class MidiBase:
    ...
    def open_virtual_port(self, port_name=b"RtMidi"):
...
cdef void midi_in_callback(double time_stamp, vector[unsigned char]* message_vector, void* py_callback) noexcept with gil:
